...
public class AccountServiceImpl implements AccountService {
    ...
    private Account mapToEntity(AccountDto accountDto) {
        ...
        UserProfile userProfile = this.userProfileRepository.findById(accountDto.getUserProfileId()).orElseThrow(() -> new ResourceNotFoundException("UserProfile", "id", accountDto.getUserProfileId()));
