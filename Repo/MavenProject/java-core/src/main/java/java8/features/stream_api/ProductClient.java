...
public class ProductClient {
    ...
    public static void main(String[] args) {
        ...
        productClient.toList();
        productClient.toSet();
        productClient.joining();
        productClient.counting();
        productClient.summingInt();
        productClient.groupingBy();
        productClient.maxBy();
        productClient.partitioningBy();
        productClient.mapping();
        productClient.match();
        productClient.findFirst();
        productClient.findAny();
    }
}
