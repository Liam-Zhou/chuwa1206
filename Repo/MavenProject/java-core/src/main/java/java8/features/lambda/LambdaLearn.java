...
//          return parameter + " " + localVariable;
    ...
    public static void main(String[] args) {
        ...
        lambdaLearn.overrideFoo();
        lambdaLearn.lambdaFoo();
        lambdaLearn.lambdaFoo2();
        lambdaLearn.testFinal();
        lambdaLearn.testEffectivelyFinal();
        lambdaLearn.testFinal21();
        lambdaLearn.testFinal22();
        lambdaLearn.testFinal3();
    }
}
