...
public class ShoppingCartAnswer {
    ...
    public static void main(String[] args) {
        ...
        // Test methods
        System.out.println("First Item Name: " + ShoppingCartAnswer.getFirstItemName(customer).orElse("No Item"));
        System.out.println("Total Price: " + ShoppingCartAnswer.getTotalPrice(Optional.of(customer)));
        System.out.println("First Item Name with Alternative: " + ShoppingCartAnswer.getFirstItemNameWithAlternative(customer));

        try {
            System.out.println("First Item Name or Throw Exception: " + ShoppingCartAnswer.getFirstItemNameOrThrowException(customer));
        } catch (EmptyCartException e) {
            e.printStackTrace();
        }

        ShoppingCartAnswer.checkItemsInCart(customer);
        ShoppingCartAnswer.printItemsInCart(customer);
    }
