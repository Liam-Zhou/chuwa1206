...
public class LinkedHashMapExerciseTest {
    ...
    public void learn_Remove_Replacing_Updating() {
        ...
        BiFunction<String, Integer, Integer> computeFunc = (k, v) -> v == null ? 42 : v + 5;
        Function<String, Integer> computeIfAbsentFunc = k -> 100;
        BiFunction<String, Integer, Integer> computeIfPresentFunc = (k, v) -> v + 50;

        map.compute("Apple", computeFunc);
        assertEquals(Integer.valueOf(15), map.get("Apple"));

        map.computeIfAbsent("Fig", computeIfAbsentFunc);
        assertEquals(Integer.valueOf(100), map.get("Fig"));

        map.computeIfPresent("Fig", computeIfPresentFunc);
