 ...
 */
public class ShoppingCartUtilZhaokuanChenFirstTry {
    ...
    /**
     * 编写一个方法，接受一个Optional<Customer>对象作为参数。如果Optional对象非空且包含的客户有购物车，计算购物车中所有商品的总价，并返回该值。
    ...
    public static String getFirstItemNameWithAlternative(Customer customer) {
        return Optional.ofNullable(customer)
                ...
                .map(Item::getName)
                .orElseGet(ShoppingCartUtilZhaokuanChenFirstTry::getRandomAlternativeItem);
    }
...
//                .map(Customer::getShoppingCart)
//                .map(ShoppingCart::getItems)
//                .ifPresentOrElse((a) -> System.out.println("购物车中有商品"), () -> System.out.println("购物车为空"));
